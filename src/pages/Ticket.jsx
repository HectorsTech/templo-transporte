           ...
           <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 md:p-8">
              ...
              <form onSubmit={handleConfirm} className="space-y-6">
                 ...
                 <div>
                    ...
                    <div className="relative">
                       <svg className="absolute left-3 top-3 w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Para contacto y notificaciones vía WhatsApp.</p>
                 </div>
